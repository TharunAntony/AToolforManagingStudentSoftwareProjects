...
Need to ensure that you have these to run the program:
...
Then configure the scr/main/resources/application.properties file to match your database:
...
It is commented out and is recommended to be only run once to create new students. Running more than once can create students with duplicate usernames as we are injecting the data into the database.
